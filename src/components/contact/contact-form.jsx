		...
		<section id="contact" className="mt-6 mb-6 md:mt-10 md:mb-10">
			...
			<Form {...form}>
				<form
					...
					className="p-4 md:p-6 w-4/5 md:w-5/6 lg:w-3/4 mx-auto text-sm lg:text-lg space-y-3 md:space-y-5 shadow-[0_0_12px] shadow-white rounded-md bg-white text-gray-500"
				>
