...
export const projects = [
	{
		...
		projectLink: "https://sivaram-take-notes.vercel.app/",
		srcImage: "/project_notes.png",
		altImage: "Image of the Project",
		aboutProject: [
			"A personal note-taking application named 'Notebook'.",
			"Allows users to create, save, and view notes effortlessly.",
			"Stores notes in the browser’s local storage, ensuring data persistence across sessions.",
			"Requires no backend server or database, making it lightweight and efficient.",
			"Demonstrates the use of Web Storage APIs for client-side data management.",
		],
	},
	{
		projectName: "WorldWeather",
		projectLink: "https://sivaram-worldweather.vercel.app/",
		srcImage: "/project_worldweather.png",
		altImage: "Image of the Project",
		aboutProject: [
			"An interactive weather application named 'WorldWeather'.",
			"Displays a world map where users can click on any location to view real-time weather information.",
			"Focuses on land areas only, excluding weather data for oceanic regions.",
			"Fetches weather details using public APIs, showcasing integration of external data sources.",
			"Highlights skills in working with interactive maps and delivering a user-friendly experience.",
		],
	},
];
